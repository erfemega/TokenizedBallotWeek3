...
export type { ITokenizedVotes } from "./contracts/TokenizedBallot.sol/ITokenizedVotes";
export { ITokenizedVotes__factory } from "./factories/contracts/TokenizedBallot.sol/ITokenizedVotes__factory";
